...
?>
  ...
  <head>
    ...
    <style>
      h2 { font-family: Arial, Helvetica, sans-serif; font-size: 22px; color: blue; margin: 6px }
  ...
  <tr>
  <td rowspan="2">
  <a href="index.php"><h1>Cooper Book Store</h1></a>
  </td>
...
function display_button($target, $name) {
  echo "<div align=\"center\"><a href=\"".$target."\"><h2>".$name."</h3>
          </a></div>";
}
